      ...
      <ColumnStackLayout expand noMargin>
        ...
        {extensionShortHeader.tier === 'community' && (
          <AlertMessage kind="warning">
            <Trans>
              ...
              by the extension team. As such, we can't guarantee it
              meets all the quality standards of official extensions. It could
              also not be compatible with older versions. In case of
        ...
        {!isCompatible && (
          <AlertMessage kind="error">
            <Trans>
              Unfortunately, this extension requires a newer version
              to work. Update version to be able to use this extension in your
              project.
            </Trans>
          </AlertMessage>
        )}
