...
export const getVariablesContainerSourceType = (
  ...
  const variablesContainersList = projectScopedContainersAccessor
    .get()
    .getVariablesContainersList();
    const getVariablesContainer = 
    typeof variablesContainersList.getVariablesContainerFromVariableName === 'function'
  ...
  return variablesContainersList.has(rootVariableName)
    ? getVariablesContainer(rootVariableName)?.getSourceType()
