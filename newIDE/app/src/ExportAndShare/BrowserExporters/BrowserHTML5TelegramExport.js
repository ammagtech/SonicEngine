...
import { getTelegramS3BaseUrl, uploadObjects } from '../../Utils/GDevelopServices/Preview';
import {
...
import {
  ...
  DoneFooter,
  ExportFlow,
} from '../GenericExporters/TelegramExport';
...
const exportPipelineName = 'browser-html5-telegram';

export const browserHTML5TelegramExportPipeline: ExportPipeline<
  ExportState,
  PreparedExporter,
  ExportOutput,
...
> = {
  ...
  const uniqueId = new Date().getTime();
    ...
    return {
      blobFiles,
      textFiles,
      gameLink: getTelegramS3BaseUrl() + `${uniqueId}/index.html`,
    };
  },
