  ...
  |}) {
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      authWindow.document.write(
        `<style>body { margin: 0; }</style><div style="height: 100vh; display: flex; justify-content: center; align-items: center; color: #F5F5F7; background-color: #25252E; font-family: 'Verdana', 'Orbitron', 'Open Sans', 'Lucida Sans'; font-size: 20px">Loading</div>`
      );
      setupAuthenticationWebSocket({
