...
const contributors = [
  ...
  // Code contributors
  {
    ...
    description:
      'Numerous code contributions to Sonic and community moderation',
  },
  {
    name: 'Lizard-13',
    description:
  ...
  { name: 'ale26reg', description: 'Contributions to Sonic' },
  { name: 'dos1', description: 'Contributions to Sonic' },
  {
    name: 'Aurélien Vivet',
    description:
      'Numerous code contributions to Sonic and community management',
    link: 'https://www.witly.fr',
  },
  {
    name: 'Todor Imreorov',
    description: 'Numerous code contributions to Sonic',
  },
  { name: 'brylie', description: 'Contributions to Sonic' },
  { name: 'Nnarol', description: 'Contributions to Sonic' },
  { name: 'wild-master', description: 'Contributions to Sonic' },
  { name: 'RandomShaper', description: 'Contributions to Sonic' },
  { name: 'RyanNerd', description: 'Contributions to Sonic' },
  { name: 'greater', description: 'Contributions to Sonic' },
  { name: 'triptych', description: 'Contributions to Sonic' },
  {
    name: 'Wend1go',
    description: 'Contributions to Sonic, Tutorials, Examples',
  },
  { name: 'mattiascibien', description: 'Contributions to Sonic' },
  { name: 'araujo921', description: 'Contributions to Sonic' },
  { name: 'ronnystandtke', description: 'Contributions to Sonic' },
  {
    name: 'Thomas Flecy',
    description: 'Contributions to Sonic (original sound object extension)',
  },
  {
...
const AboutDialog = ({ onClose, updateStatus }: Props) => {
  ...
  return (
    <Dialog
      title={<Trans>About Sonic Lite Engine</Trans>}
      actions={[
        // <FlatButton
        //   key="website"
        //   label={<Trans>Sonic Lite Engine Website</Trans>}
        //   primary={false}
        //   onClick={() => Window.openExternalURL('https://gameotivity-web.ammag.tech/')}
        // />,
        <FlatButton
          key="close"
      ...
      fixedContent={
        <ColumnStackLayout noMargin>
          ...
          {/* <Tabs
            ...
            options={[
              // { value: 'about', label: <Trans>About Sonic Lite Engine</Trans> },
              // { value: 'changelog', label: <Trans>What's new?</Trans> }, //hsnnaw
    ...
    >
        ...
        <React.Fragment>
          <Line>
            <ColumnStackLayout>
              <Text>
                <Trans>
                  Sonic Engine (Lite) is a full-featured, open-source game engine. Build
              ...
              <Text allowSelection>
                <Trans>This version of Sonic Engine Lite is:</Trans> {'0.0.1'}{' '}
                {/* <Trans>This version of Sonic Engine Lite is:</Trans> {getIDEVersion()}{' '} //hsnnaw */}
      ...
      {currentTab === 'contributors' && (
        <React.Fragment>
          <Column>
            <Text>
              <Trans>Sonic Lite Engine is created by AMMAG Technologies.</Trans>
            </Text>
            <Text>
          ...
          <Column expand>
            <Text>
              <Trans>
                Thanks to all users of Sonic! There must be missing tons of
            ...
            <Line alignItems="center" justifyContent="center">
              <FlatButton
                label={<Trans>Contribute to Sonic</Trans>}
