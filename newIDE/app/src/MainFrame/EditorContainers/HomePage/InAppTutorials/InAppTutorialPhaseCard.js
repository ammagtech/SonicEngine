          ...
          <Column noMargin alignItems="center" expand>
                ...
                backgroundImage: locked
                  ...
                  : disabled
                    ? gdevelopTheme.palette.type === 'dark'
                      ? 'linear-gradient(90deg, rgba(62, 65, 85, 1), rgba(30, 31, 37, 1))'
                      : 'linear-gradient(90deg, rgba(62, 65, 85, 1), rgba(30, 31, 37, 1))'
                    : 'linear-gradient(90deg, rgba(62, 65, 85, 1), rgba(30, 31, 37, 1))', //hsnnaw
              }}
            >
              {locked ? (
            ...
            <div
              style={{
                ...
                backgroundImage: 'linear-gradient(90deg, rgba(237, 27, 118, 1), rgba(45, 72, 255, 1)) 1',
