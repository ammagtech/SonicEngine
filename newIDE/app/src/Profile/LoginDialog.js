...
import GameotivitySidelogo from '../UI/CustomSvgIcons/GameotivitySidelogo';
...
const LoginDialog = ({
  ...
  const dialogContent = (
    <ColumnStackLayout
      ...
      alignItems="center"
    >
      <GameotivitySidelogo fontSize="large" />
  ...
  return (
    <Dialog
      ...
      id="login-dialog"
      // actions={actions} //hsnaw
      // secondaryActions={secondaryActions} //hsnaw
