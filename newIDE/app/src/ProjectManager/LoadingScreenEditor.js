            ...
            <ResponsiveLineStackLayout noResponsiveLandscape noMargin>
              <Column expand noMargin justifyContent="center">
                <Checkbox
                  label={
                    <Trans>
                      Display Sonic Engine logo at startup (in exported game)
                    </Trans>
                  }
              ...
              <Column expand noMargin justifyContent="center">
                <SelectField
                  fullWidth
                  floatingLabelText={<Trans>Sonic Lite Engine logo style</Trans>}
            ...
            <ResponsiveLineStackLayout noResponsiveLandscape noMargin>
              <Column expand noMargin justifyContent="center">
                <Checkbox
                  label={
                    <Trans>
                      Display Sonic Engine watermark after the game is loaded (in
                      exported game)
                    </Trans>
                  }
              ...
              <Column expand noMargin justifyContent="center">
                <SelectField
                  fullWidth
                  floatingLabelText={
                    <Trans>Sonic Engine watermark placement</Trans>
                  }
